...
const heartIconImage = require('../assets/heart.png')
const fingersIconImage = require('../assets/fingers.png')
...
export const ProductDetail = ({
   ...
   */
  const renderName = () => {
    return <View style={styles.nameTextWrapper}><Text style={styles.nameText}>{product.product}</Text></View>;
  };
   ...
   * @return {JSX.Element}
   */
  const renderPrice = (hideDiscountPrice) => {
    ...
    return (
      <View style={styles.priceWrapper}>
        ...
        {!hideDiscountPrice && showDiscount && isProductPriceZero && (
  ...
  const renderOldDiscussion = () => {
    ...
    return (
      <Section
        title={''}
        wrapperStyle={styles.discussionWrapperStyle}
        showRightButton={true}
        rightButtonText={i18n.t('Write a Review')}
        onRightButtonPress={() => {
