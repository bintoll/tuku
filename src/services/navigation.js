            ...
            stack: {
              ...
              options: {
                bottomTab: {
                  ...
                  text: i18n.t('Catalog'),
                  selectedIcon: iconsMap.catalogSelected,
                  selectedTextColor: '#0024FF',
                  selectedIconColor: '#0024FF',
                  fontFamily: FontFamily.SFPRODISPLAY_REGULAR,
                  fontSize: 12
            ...
            stack: {
              ...
              options: {
                bottomTab: {
                  ...
                  text: i18n.t('Cart'),
                  selectedIcon: iconsMap['shopping-cartSelected'],
                  selectedTextColor: '#0024FF',
                  selectedIconColor: '#0024FF',
                  fontFamily: FontFamily.SFPRODISPLAY_REGULAR,
                  fontSize: 12
            ...
            stack: {
              ...
              options: {
                bottomTab: {
                  ...
                  selectedIcon: iconsMap.favoriteSelected,
                  selectedTextColor: '#0024FF',
                  selectedIconColor: '#0024FF',
                  fontFamily: FontFamily.SFPRODISPLAY_REGULAR,
                  fontSize: 12
            ...
            stack: {
              ...
              options: {
                bottomTab: {
                  ...
                  text: i18n.t('Profile'),
                  selectedIcon: iconsMap.personSelected,
                  selectedTextColor: '#0024FF',
                  selectedIconColor: '#0024FF',
                  fontFamily: FontFamily.SFPRODISPLAY_REGULAR,
                  fontSize: 12
...
export function popLogin(componentId, params) {
